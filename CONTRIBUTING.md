...
Allowed tags are `arcade`, `puzzle`, `platformer`, `simulation`, `tutorial`, `two-button`, and `procedural`. All submitted cartridge source and artwork must use the MIT License and declare `"license": "MIT"` in `cartridge.json`.
