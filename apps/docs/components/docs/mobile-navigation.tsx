      ...
      <Dialog.Portal>
        ...
        >
          <div className="flex h-14 shrink-0 items-center border-b border-border pl-4">
            ...
            <Dialog.Close
              className="ml-auto grid size-14 place-items-center border-l border-border bg-background text-muted hover:bg-foreground hover:text-background"
          ...
          <nav className="grid shrink-0 border-t border-border p-3" aria-label="tynt project links">
            <a
              className="flex min-h-11 items-center gap-3 border border-transparent px-3 text-xs text-muted no-underline hover:border-foreground hover:bg-foreground hover:text-background"
              href="https://tynt.dev/gallery"
            >
              <Gamepad width={18} height={18} aria-hidden="true" />
              Open the tynt gallery
            </a>
            <a
              className="flex min-h-11 items-center gap-3 border border-transparent px-3 text-xs text-muted no-underline hover:border-foreground hover:bg-foreground hover:text-background"
