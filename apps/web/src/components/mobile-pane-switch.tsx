...
export function MobilePaneSwitch({ value, onChange }: MobilePaneSwitchProps) {
  const buttonClassName =
    "min-w-0 cursor-pointer border-0 border-r border-border bg-background text-foreground last:border-r-0 hover:bg-foreground hover:text-background aria-pressed:bg-foreground aria-pressed:text-background aria-pressed:hover:bg-[#555555]";
  return (
    <div
