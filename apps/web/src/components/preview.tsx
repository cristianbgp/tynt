    ...
    <section className="preview-pane grid min-h-0 place-content-center items-center bg-muted px-[8px] py-[24px] [container-name:preview] [container-type:inline-size]" aria-label="Game preview">
      ...
      >
        <div className="preview-frame relative mx-auto grid w-max place-items-center border border-foreground bg-foreground">
          <canvas className="block h-auto w-[160px] aspect-[10/9] [image-rendering:pixelated]" ref={canvasRef} width="160" height="144" aria-label="Game canvas" />
          {showError ? (
            <div className="preview-error absolute inset-0 grid content-center gap-[6px] border-4 border-[var(--error)] bg-[rgb(255_241_240/94%)] text-center uppercase text-[var(--error)]" aria-hidden="true">
        ...
        <div id="preview-help" className="preview-hints mt-[9px] flex justify-between text-[10px] tracking-[0.06em] text-[#555555]">
          <span>160 × 144</span>
