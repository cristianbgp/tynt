...
const options = TYNT_API_COMPLETIONS.map(({ label, signature, description, snippet }) =>
  snippetCompletion(snippet, { label, detail: signature, info: description, type: "function" }),
);
