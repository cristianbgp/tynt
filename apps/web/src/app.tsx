...
const GalleryPage = lazy(() =>
  import("@/pages/gallery-page").then(({ GalleryPage }) => ({ default: GalleryPage })),
);
const LibraryPage = lazy(() =>
  import("@/pages/library-page").then(({ LibraryPage }) => ({ default: LibraryPage })),
);
const LocalPlayPage = lazy(() =>
  import("@/pages/local-play-page").then(({ LocalPlayPage }) => ({ default: LocalPlayPage })),
);
const NotFoundPage = lazy(() =>
  import("@/pages/not-found-page").then(({ NotFoundPage }) => ({ default: NotFoundPage })),
);
const PublicPlayPage = lazy(() =>
  import("@/pages/public-play-page").then(({ PublicPlayPage }) => ({ default: PublicPlayPage })),
);
const SpritePage = lazy(() =>
  import("@/pages/sprite-page").then(({ SpritePage }) => ({ default: SpritePage })),
);
const SoundPage = lazy(() =>
  import("@/pages/sound-page").then(({ SoundPage }) => ({ default: SoundPage })),
);
...
export function App({ library = browserCartridgeLibrary }: AppProps) {
  ...
  return (
    <TooltipProvider delayDuration={500}>
      <Suspense
        fallback={
          <main className="grid min-h-full place-items-center" role="status">
            Loading tynt…
          </main>
        }
      >
        <Routes>
          ...
          <Route
            path="gallery"
            element={<GalleryPage soundEnabled={soundEnabled} onSoundToggle={toggleSound} />}
          />
          <Route
            path="cartridges/:slug"
            element={<CartridgePage soundEnabled={soundEnabled} onSoundToggle={toggleSound} />}
          />
          <Route
            path="library"
            element={
          ...
          <Route
            ...
            element={<PublicPlayPage soundEnabled={soundEnabled} onSoundToggle={toggleSound} />}
          />
          <Route
            path="play/local/:id"
            element={
          ...
          <Route
            path="sprites"
            element={<SpritePage soundEnabled={soundEnabled} onSoundToggle={toggleSound} />}
          />
          <Route
            path="sounds"
            element={<SoundPage soundEnabled={soundEnabled} onSoundToggle={toggleSound} />}
          />
